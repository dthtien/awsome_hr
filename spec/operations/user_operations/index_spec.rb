...
RSpec.describe UsersOperations::Index do
  ...
  context 'Search imployee of user', search_imployee: true do
    let(:params) do
  ...
  context 'Search manager of user', search_imployee: true do
    let(:params) do
  ...
  context 'Relationship between', search_imployee: true do
    let(:params) do
